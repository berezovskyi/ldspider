...
import java.io.PrintWriter; // This import seems unused in the snippet, but I'll keep it as it was there.
import java.net.URI;
...
public class ABoxTBoxTest extends TestCase {
	...
	private void crawl(int rounds, Crawler.Mode crawlingMode, boolean stayOnDomain) throws IOException {
		...
		c.evaluateBreadthFirst(frontier, new SeenMem(), new DummyRedirects(), rounds, 10000, 10000, -1, false, crawlingMode);
